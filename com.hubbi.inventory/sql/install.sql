...
-- Índices Clave
CREATE INDEX IF NOT EXISTS idx_inventory_stock_location ON com_hubbi_inventory_stock(location_id);
CREATE INDEX IF NOT EXISTS idx_inventory_movements_item ON com_hubbi_inventory_movements(item_id);
CREATE INDEX IF NOT EXISTS idx_inventory_movements_date ON com_hubbi_inventory_movements(created_at);
CREATE INDEX IF NOT EXISTS idx_inventory_reservations_ref ON com_hubbi_inventory_reservations(reference_id);
