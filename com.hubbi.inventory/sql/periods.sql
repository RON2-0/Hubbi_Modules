...
CREATE INDEX IF NOT EXISTS hubbi_idx_periods_year_month ON hubbi_fiscal_periods(year, month);
CREATE INDEX IF NOT EXISTS hubbi_idx_periods_status ON hubbi_fiscal_periods(status);
CREATE INDEX IF NOT EXISTS hubbi_idx_periods_current ON hubbi_fiscal_periods(is_current) WHERE is_current = TRUE;
CREATE INDEX IF NOT EXISTS hubbi_idx_snapshots_period ON hubbi_period_snapshots(period_id);
